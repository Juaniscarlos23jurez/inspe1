...
class segudad1adaptador(private val segundo1: ArrayList<segundad1>, private val valor1dato: String, private val valor2dato: String,
                        private val context: Context
) : RecyclerView.Adapter<segudad1adaptador.Myholder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Myholder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.datos4,parent,false)
