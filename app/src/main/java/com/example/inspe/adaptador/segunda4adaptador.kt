...
class segunda4adaptador(private val segundo1: ArrayList<segunda4>, private val valor1dato: String, private val valor2dato: String,
                        private val context: Context
) : RecyclerView.Adapter<segunda4adaptador.Myholder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Myholder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.datos6,parent,false)
