...
class adaptadorsegundo(private val segundo1: ArrayList<segundo>, private val valor1dato: String, private val valor2dato: String,
                       private val context: Context) : RecyclerView.Adapter<adaptadorsegundo.Myholder>() {
