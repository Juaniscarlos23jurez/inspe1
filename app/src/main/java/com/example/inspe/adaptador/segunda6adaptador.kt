...
class segunda6adaptador(private val segundo1: ArrayList<segunda6>, private val valor1dato: String, private val valor2dato: String,
                        private val context: Context
) : RecyclerView.Adapter<segunda6adaptador.Myholder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Myholder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.datos8,parent,false)
