...
public class adaptadorsi4 extends RecyclerView.Adapter<adaptadorsi4.NotaViewHolder> {
private List<datos4> notasList2;

    private SQLiteDatabase database; // Declarar la instancia de la base de datos
    private Context context; // Agregar esta variable

    public adaptadorsi4(List<datos4> notasList2, Context context) { // Modificar el constructor
...
public NotaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        .inflate(R.layout.datos4, parent, false);
...
public void onBindViewHolder(@NonNull NotaViewHolder holder, int position) {
    datos4 nota = notasList2.get(position);
    ...
    holder.si.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            dbHelper.insertText(text, depatemantos, cantidad, psisi ,respusta, Comentario);
