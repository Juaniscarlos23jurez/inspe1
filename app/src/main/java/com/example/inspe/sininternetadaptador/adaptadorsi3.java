...
public class adaptadorsi3 extends RecyclerView.Adapter<adaptadorsi3.NotaViewHolder> {
private List<datos3> notasList2;

    private SQLiteDatabase database; // Declarar la instancia de la base de datos
    private Context context; // Agregar esta variable

    public adaptadorsi3(List<datos3> notasList2, Context context) { // Modificar el constructor
...
public NotaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        .inflate(R.layout.datos6, parent, false);
...
public void onBindViewHolder(@NonNull NotaViewHolder holder, int position) {
    datos3 nota = notasList2.get(position);
