...
public class adaptadorsi1 extends RecyclerView.Adapter<adaptadorsi1.NotaViewHolder> {
private List<datos1> notasList1;

    private SQLiteDatabase database; // Declarar la instancia de la base de datos
    private Context context; // Agregar esta variable

    public adaptadorsi1(List<datos1> notasList1, Context context) { // Modificar el constructor
        this.notasList1 = notasList1;
...
public void onBindViewHolder(@NonNull NotaViewHolder holder, int position) {
    datos1 nota = notasList1.get(position);
