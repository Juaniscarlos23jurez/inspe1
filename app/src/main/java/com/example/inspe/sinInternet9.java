...
public class sinInternet9 extends AppCompatActivity {
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    private void cargarDatosDesdeSQLite() {
        ...
        notasList.add(new datos( "Alimentos preparados", 17, "Procedimiento de fruta partida", 5 ));
        notasList.add(new datos( "Alimentos preparados", 18, "¿Cuentan con los materiales necesarios?", 5 ));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (result != null) {
            ...
            if ("-8".equals(qrContent)) {
                startActivity(new Intent(sinInternet9.this,sinInternet.class));
